<template>
  <Teleport to="body">
    ...
    <svg
      ...
      class="invisible absolute z-50 -translate-x-1/2 -translate-y-1/2 rounded-full border border-primary-200 bg-accent fill-primary-50 p-1"
    >
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
      ...
      <div class="w-full">
        ...
        <ul v-if="gameActive" class="font-title text-sm uppercase leading-relaxed tracking-tight">
          <li>
            ...
            Press and hold <span class="opacity-50">to charge</span>
          </li>
          <li>
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            Drag <span class="opacity-50">to aim</span>
          </li>
          <li>
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            Release <span class="opacity-50">to shoot</span>
          </li>
        </ul>
      </div>
